package fastut.util.generics.parser;
...
import fastut.util.generics.tree.BaseType;
...
import fastut.util.generics.tree.ReturnType;
...
/**
 * Parser for type signatures, as defined in the Java Virtual // Machine Specification (JVMS) chapter 4. Converts the
 * signatures into an abstract syntax tree (AST) representation. // See the package sun.reflect.generics.tree for
 * details of the AST.
 */
public class SignatureParser {
    ...
    /**
     * Parses a class signature (as defined in the JVMS, chapter 4) and produces an abstract syntax tree representing
     * it.
     *
    ...
    /**
     * Parses a method signature (as defined in the JVMS, chapter 4) and produces an abstract syntax tree representing
     * it.
     *
    ...
    private ClassSignature parseClassSignature() {
        assert (index == 0);
        return ClassSignature.make(parseZeroOrMoreFormalTypeParameters(), parseClassTypeSignature(),
    ...
    private MethodTypeSignature parseMethodTypeSignature() {
        ...
        assert (index == 0);
        return MethodTypeSignature.make(parseZeroOrMoreFormalTypeParameters(), parseFormalParameters(),
                                        parseReturnType(), parseZeroOrMoreThrowsSignatures());
    }
    ...
    private TypeSignature[] parseZeroOrMoreTypeSignatures() {
        ...
        /*
         * while( matches(current(), 'B', 'C', 'D', 'F', 'I', 'J', 'S', 'Z', 'L', 'T', '[') ) {
         * ts.add(parseTypeSignature()); }
         */
