...
public class FormatOut {
    ...
    public static final String LIST_TYPE_STR         = "List";
    public static final String ARRAYLIST_TYPE_STR    = "ArrayList";
    public static final String MAP_TYPE_STR          = "Map";
    ...
    static String asExpression(String typeName, String varName, String valueStr) {
        return new StringBuilder().append(asSimpleTypeName(typeName)).append(BLANK_STR).append(varName).append(BLANK_STR).append(EQ_STR).append(BLANK_STR).append(valueStr).append(SEMI_STR).append(NEW_LINE).toString();
    }
    ...
    public static String asString(Object value) {
        ...
        if (value instanceof String) {
            return builder.append(DOUBLE_QUOTES_STR).append(value).append(DOUBLE_QUOTES_STR).toString();
        }
    ...
    static String asListDeclartion(ListSignaturedType st, String varName, Object rawValue) {
        ...
        String typeName = new StringBuilder().append(LIST_TYPE_STR).append(LT_STR).append(argSimpleTypeName).append(GT_STR).toString();
    ...
    static String asMapDeclartion(MapSignaturedType st, String varName, Object rawValue) {
        ...
        String typeName = new StringBuilder().append(MAP_TYPE_STR).append(LT_STR).append(kSimpleTypeName).append(COMMA_STR).append(BLANK_STR).append(vSimpleTypeName).append(GT_STR).toString();
        String value = new StringBuilder().append(NEW_STR).append(BLANK_STR).append(HASHMAP_TYPE_STR).append(LT_STR).append(kSimpleTypeName).append(COMMA_STR).append(BLANK_STR).append(vSimpleTypeName).append(GT_STR).append(LEFT_PARENTHESES_STR).append(RIGHT_PARENTHESES_STR).toString();
        StringBuilder resultBuilder = new StringBuilder(asExpression(typeName, varName, value));
        if (rawValue != null) {
    ...
    public static String asOperation(String varName, String opName, String... params) {
        StringBuilder builder = new StringBuilder();
        builder.append(varName).append(DOT_STR).append(opName).append(LEFT_PARENTHESES_STR);
        if (params.length >= 1) {
