...
public class SourceFileData extends CoverageDataContainer implements Comparable<Object>, HasBeenInstrumented {
    ...
    public SourceFileData(String name){
        if (name == null) throw new IllegalArgumentException("Source file name must be specified.");
        this.name = name;
    }
    ...
    public int compareTo(Object o) {
        if (!o.getClass().equals(SourceFileData.class)) return Integer.MAX_VALUE;
    ...
    public boolean containsInstrumentationInfo() {
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                if (!classData.containsInstrumentationInfo()) return false;
            }
        } finally {
            lock.unlock();
        }
    ...
    /**
     * Returns true if the given object is an instance of the SourceFileData class, and it contains the same data as
     * this class.
     */
    ...
    public LineData getLineCoverage(int lineNumber) {
        ...
        try {
            ...
            while (iter.hasNext()) {
                ClassData classData = (ClassData) iter.next();
                if (classData.isValidSourceLineNumber(lineNumber)) return classData.getLineCoverage(lineNumber);
            }
        } finally {
            lock.unlock();
        }
    ...
    /**
     * @return The name of this source file without the file extension in the format
    ...
    /**
     * @return The name of the package that this source file is in. In the format
