...
public abstract class StringUtil {
     ...
     * </p>
     * <p>
     * NOTE: it is known that a similar function is included in jdk 1.4 as replaceAll(), but is written here so as to
     * allow backward compatibility to users using SDK's prior to 1.4
     * </p>
     *
    ...
    /**
     * Takes a double and turns it into a percent string. Ex. 0.5 turns into 50%
     *
     * @param value
